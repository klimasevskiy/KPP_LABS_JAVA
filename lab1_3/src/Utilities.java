...
public class Utilities {
    ...
    public static void PrintTable(Container<Contacts> contacts)
    {
        PrintLine();
    ...
    public static void Sort_by(Container<Contacts> listGoods, int sort_by)
    {
        switch (sort_by) {
            case 1 -> listGoods.sort(Comparator.comparing(x -> x.Name));
            case 2 -> listGoods.sort(Comparator.comparing(x -> x.Birth));
            case 3 -> listGoods.sort(Comparator.comparing(x -> x.Created_date_time));
            default -> {
            }
        }
